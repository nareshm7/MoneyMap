      ...
      >
        ...
        >
          <Heading size={"md"} mb={"4"} color={"gray.600"}>
            Balance is <span>&#8377;</span> {totalIncome - totalExpense}
          </Heading>
          <Flex
            justifyContent={"space-evenly"}
            alignItems={"center"}
          ...
          >
            <Flex flexDirection={"column"}>
              <Heading color={"gray.700"}><span>&#8377;</span>  {totalIncome}</Heading>
          ...
          >
            <Flex flexDirection={"column"}>
              <Heading color={"gray.700"}><span>&#8377;</span>  {totalExpense}</Heading>
